...
export declare namespace ChatThreadUtils {
    const SYMBOL: symbol;
}
/**
 * @since 2.0.0
...
export declare type ConfigurationParticipantObject = {
    [index: string]: any;
    name: string;
    firstName: string;
    id: FacebookId;
...
export declare type ConfigurationParticipantsObject = {
    [index: string]: ConfigurationParticipantObject;
};
export declare type ConfigurationChatThreadObject = {
    name?: string;
    participants: ConfigurationParticipantsObject;
    overrides?: object;
};
export declare type ConfigurationChatThreadsObject = {
    [index: string]: ConfigurationChatThreadObject;
};
export declare type ChatThreadParticipantConsumer = (chatThreadId: FacebookId, participantVanityOrId: FacebookId, participantObj: ConfigurationParticipantObject, participantsObj: ConfigurationParticipantsObject) => boolean | void | Promise<boolean | void>;
